...
export async function preloadHandlebarsTemplates() {
  const templatePaths = [
    ...
    'systems/neon-relic/templates/actor/hq/hq-header.hbs',
    'systems/neon-relic/templates/actor/hq/hq-overview.hbs',
    'systems/neon-relic/templates/actor/hq/hq-upgrades.hbs',
    'systems/neon-relic/templates/actor/hq/hq-personnel.hbs',
    'systems/neon-relic/templates/actor/hq/hq-members.hbs',
    'systems/neon-relic/templates/actor/hq/hq-vault.hbs',
    'systems/neon-relic/templates/actor/hq/hq-log.hbs',
